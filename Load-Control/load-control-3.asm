/*     External control for everything associated with loading and recylcling through game exits with reloads
	...
	2025-01-02	v3 switch to exomizer3 packed
	2025-01-08	v3 changed memmap, removed one note screen
*/

.filenamespace loader


// origins for game/asset blocks, buffers
// the main game file imports all labels from the loader namespace so it shares these
.label Game 		= $1000
.label Chars 		= $4000
.label Map		= $ac00
.label Sounds 		= $e000
.label depackBuffer	= $0320		
...
.var 	vicMem1 = vicBank("char", $0000, $0000, $2800, $2000)
.var 	vicMem2 = vicBank("char", $0000, $0000, $2800, $2400)
...
getGame:	//lda #LIGHT_GREY		// game code contains initial player variables at $8000, but not zp
		//sta $d020
		lda #$01		// $01 = main program
		ldx #<Game		//load address
		ldy #>Game
                jsr LoadExomizer3Raw    //Load file 01 as unpacked data and with startaddress
                bcc !n+          	//Error if carry set
		jmp LoadError
!n:


getSounds:	//lda #DARK_GREY
		//sta $d021
		lda #$02		// $06 = wavetables and sound vector tables; also note table for into tune
		ldx #<Sounds		//load address
		ldy #>Sounds
                jsr LoadExomizer3Raw    //Load file 01 as unpacked data and with startaddress
                bcc !n+          	//Error if carry set
		jmp LoadError
...
do:		
		...
		ldx #10			//initialize pointers so memcpy routines don't trash stuff
!lp:		lda initZpPtrTable-1,x
		sta $cd-1,x		
		dex
		bne !lp-	
...
endGame:	// main game exits here
		...
		// determine if the full game was completed successfully
		lda $806a		//GameLevel_gbl
		cmp #5
		bne getVars
		lda #3			// if yes, set to 3 = victory screen
		sta $a0
		
		
getVars:	// reset the player variables; this is overkill but I just copied the block
		//lda #BLACK
		//sta $d020
		ldx #140		// 140 bytes $8000-808b. block2 starts $808c
!lp:		lda initVarTable-1,x
		sta $8000-1,x		//player variable table in block2 
		dex
		bne !lp-	
...
.pc = $0a00 "Loader *Runtime*"
		#import "loader/config.asm"
		#import "loader/loader.asm"			//runtime, length $ef
		#import "loader/loadexomizer3.asm"		//runtime

.pc = * "Player variable initialization table (was file 05)"
initVarTable:	//140 bytes
		.byte $3d, $5b, $20, $31,   $00, $00, $0f, $00,   $00, $03, $00, $00,   $0f, $00, $00, $03
		.byte $04, $80, $0a, $80,   $10, $80, $1c, $00,   $00, $00, $07, $07,   $18, $80, $1a, $80
		.byte $3b, $00, $2d, $00,   $79, $00, $00, $75,   $00, $00, $65, $00,   $2d, $00, $79, $00
		.byte $00, $7e, $01, $00,   $00, $00, $c8, $b6,   $00, $00, $00, $00,   $00, $c8, $3b, $00
		
		.byte $00, $00, $20, $80,   $2a, $80, $42, $80,   $00, $00, $34, $80,   $3b, $80, $4a, $80
		.byte $00, $00, $00, $94,   $00, $95, $00, $96,   $00, $97, $00, $00,   $52, $80, $5a, $80
		.byte $3e, $68, $93, $53,   $60, $80, $62, $80,   $04, $06, $00, $00,   $00, $00, $64, $64
		.byte $00, $00, $01, $01,   $00, $00, $10, $1a,   $08, $08, $00, $00,   $00, $00, $00, $00
		
		.byte $00, $00, $0f, $0f,   $01, $01, $00, $24,   $16, $00, $86, $a1

.pc = * "ZP pointer initialization table"
initZpPtrTable: //10 bytes
		.byte $8f, $b0, $0f, $b0,   $04, $80, $20, $80,   $34, $80


		
.pc = $0d00 "Loader Init Disposable"
...
.var note1 = LoadBinary("note-screens/note1.bin")
.var note2 = LoadBinary("note-screens/note2.bin")

/*	sound effect wavetables for schreckenstein sounds
	...
	2025-01-08	v7 changed nothing from 1 frame to 16 frames for lightning delay
*/
...
nothing:
// just nothing
.byte 16,  $00, $0f, $00, $00, $00	// increase to 16 frames from 1 frame for improvement in lightning delay
//-----------------------------------------------------------------------------------------------------------------
footstep:
